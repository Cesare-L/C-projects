...
- 8092.c: this program will generate a pseudorandom 8092 bit passphrase (over 1000 characters), the passphrase is actually quite secure even if pseudorandom, it is virtually impossibile to crack without reverse engineering the original program 8092.c and abusing the rand() function vulnerabilities. 
